...
\switchcolumn
poemtitle{Summa Summarum (Song Six)}
Sing song six using any of the previous melodies (they all fit together) or any of
\begin{itemize}
  \item Amazing Grace
  \item America the Beautiful
  \House of the Rising Sun
  \item Oh Little Town of Bethlehem
  \item the thematic tune of Smetana's Vltava
\end{itemize}
\begin{verse}
The atoms that we are traverse\\
...
begin{verse}
We’re hydrogen from the Big Bang,\\
we’re oxygen from stars,\\
that traveled here from way back then\\
to bodies such as ours.\\
end {verse}
begin{verse}
By day we see the shining sun,\\
by night the galaxy.\\
We are not each leaf one by one,\\
we’re the entire tree!\\
end {verse}
begin{verse}
The love that we share mutually\\
can be our way ahead,\\
our way towards the mystery\\
of where we will be led.\\
end {verse}
begin{verse}
United, strong and free of fear,\\
in harmony and proud\\
and loudly since we all cohere.\\
The truth we sing out loud.\\
end {verse}
\switchcolumn
poemtitle{Summa Summarum (Song Sechs)}
Singe Song Sechs mit einer beliebigen der vorigen Melodien (sie passen alle zusammen) oder der Melodie von 
\begin{itemize}
  \item Amazing Grace
  \item Weil heute Dein Geburtstag ist
  \House of the Rising Sun
  \item Oh Kleines Städtchen Bethlehem
  \item Moldau-Thema aus Smetanas Die Moldau
\end{itemize}
\begin{verse}
Aus abgrundtiefer Ewigkeit\\
erwacht der Staub und singt\\
in Kindern der Unendlichkeit,\\
wo unser Lied erklingt.\\
\end{verse}

\begin{verse}
Der Wasserstoff vom Urknall kam.\\
Der Sauerstoff von Stern’n.\\
Und ihr Zusammenspiel hier nahm\\
die Form von uns hier gern!\\
\end{verse}

\begin{verse}
Wir seh’n bei Tag den Sonnenschein,\\
bei Nacht den Weltenraum.\\
Wir sind nicht jedes Blatt allein,\\
wir sind der ganze Baum!\\
\end{verse}

\begin{verse}
die Liebe, die zu uns gehört,\\
führt zu was vor uns steht,\\
zu dem was sie heraufbeschwört,\\
wo unser Weg hin geht.\\
\end{verse}

\begin{verse}
Vereint und stark, frei von Terror,\\
harmonisch und vertraut\\
und lauthals im Verbund sonor.\\
 Die Wahrheit singt man laut.\\
end{verse]
\switchcolumn
